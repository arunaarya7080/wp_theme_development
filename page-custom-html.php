<?php
/**
 *custom page html show in wordpress website
 * @package html2wp
 */

get_header('html_page_h');       ////// custom header add for sample pages
?>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="<?php echo get_home_url(); ?>"><span>HTML</span>2WP</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
       ...
       <li><a href="<?php echo get_home_url(); ?>">back_to_Home</a></li>
      ...
      <div class="container">
        ...
        <div class="row awesome-project-content">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design development">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="<?php echo get_template_directory_uri(); ?> ./assets/img/portfolio/1.jpg" alt="" /></a>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 photo">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="<?php echo get_template_directory_uri(); ?> ./assets/img/portfolio/2.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="<?php echo get_template_directory_uri(); ?> ./assets/img/portfolio/3.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?php echo get_template_directory_uri(); ?> ./assets/img/portfolio/3.jpg">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 photo development">
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?php echo get_template_directory_uri(); ?> ./assets/img/portfolio/4.jpg">
                      <h4>Creative Team</h4>
                      <span>Web design</span>
                    </a>
                  </div>
            ...
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?php echo get_template_directory_uri(); ?> ./assets/img/portfolio/5.jpg">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design photo">
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?php echo get_template_directory_uri(); ?> ./assets/img/portfolio/6.jpg">
                      <h4>Night Hill</h4>
                      <span>Photoshop</span>
                    </a>
                  </div>
            ...
            <div class="footer-content">
              <div class="footer-head">
                ...
                <div class="flicker-img">
                  ...
                  <a href="#"><img src="<?php echo get_template_directory_uri(); ?> ./assets/img/portfolio/2.jpg" alt=""></a>
                  <a href="#"><img src="<?php echo get_template_directory_uri(); ?> ./assets/img/portfolio/3.jpg" alt=""></a>
                  <a href="#"><img src="<?php echo get_template_directory_uri(); ?> ./assets/img/portfolio/4.jpg" alt=""></a>
                  <a href="#"><img src="<?php echo get_template_directory_uri(); ?> ./assets/img/portfolio/5.jpg" alt=""></a>
                  <a href="#"><img src="<?php echo get_template_directory_uri(); ?> ./assets/img/portfolio/6.jpg" alt=""></a>
                </div>
              </div>
            </div>
          </div>
